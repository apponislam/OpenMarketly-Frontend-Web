...
export default function FaqsPage() {
    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto font-sans">
            <div>
                <h1 className="text-2xl font-bold tracking-tight text-gray-900 md:text-3xl">Frequently Asked Questions (FAQs)</h1>
                <p className="mt-1.5 text-sm text-gray-500">Configure Q&A help docs displayed in public user centers.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4 h-fit">
                    <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                        <Plus className="h-5 w-5 text-[#2c1654]" /> Add New FAQ
                    </h2>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm lg:col-span-2 space-y-4">
                    <h2 className="text-lg font-bold text-gray-900">Current Q&A Lists</h2>
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq) => (
                            <div key={faq._id} className="p-4 border border-gray-100 rounded-2xl bg-[#f8f7fc] relative group hover:border-[#2c1654]/30 transition-colors">
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 p-1.5 text-red-500 hover:bg-red-50 rounded-lg transition-colors cursor-pointer"
                                >
                        ...
                        {faqs.length === 0 && (
                            <p className="text-sm text-gray-400 py-8 text-center">No FAQ records added yet.</p>
                        )}
                    </div>
                </div>
            </div>
