                ...
                <div className="py-8" style={{ background: "linear-gradient(135deg, rgb(44, 22, 84), rgb(74, 43, 140))" }}>
                    <div className="max-w-7xl mx-auto px-4 sm:px-6">
                        <nav className="flex items-center gap-1.5 text-sm text-purple-300 mb-3">
                            <button onClick={() => router.push("/")} className="hover:text-white transition-colors font-medium cursor-pointer">
                                Home
                            </button>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-right w-3.5 h-3.5" aria-hidden="true">
