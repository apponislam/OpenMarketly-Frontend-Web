...
export function HomePage({ onShopClick, onView, onAddToCart, onCategoryClick, banners, categories, todayDeals, trendingProducts }: HomePageProps) {
            ...
            <section className="relative overflow-hidden transition-all duration-700" style={{ background: "linear-gradient(135deg, #100828 0%, #2c1654 50%, #4a2b8c 100%)" }}>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-32">
                    <div className="max-w-xl">
                        ...
                        <p className="text-base text-purple-200 mb-9 leading-relaxed max-w-sm">{banners[activeBanner]?.subtitle || "Discover products from trusted sellers, compare options, and shop everything you love."}</p>
