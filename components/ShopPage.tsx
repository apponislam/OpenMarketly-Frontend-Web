...
export function ShopPage({ onBack, onView, onAddToCart, products, activeFilter, setActiveFilter }: ShopPageProps) {
        ...
        <main className="min-h-screen bg-[#f8f7fc]">
            ...
            <div className="py-8" style={{ background: "linear-gradient(135deg, #2c1654, #4a2b8c)" }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <h1 className="text-3xl font-black text-white">{activeFilter === "All" || activeFilter === "All Categories" ? "All Products" : activeFilter}</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
                    <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide pb-1">
                        {filters.map((f) => (
                            <button
                                ...
                                style={activeFilter === f || (f === "All" && activeFilter === "All Categories") ? { backgroundColor: "#2c1654", color: "#fff", borderColor: "#2c1654" } : { backgroundColor: "#fff", color: "#374151", borderColor: "#e5e7eb" }}
                            >
                                {f}
                            </button>
                        ))}
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="text-sm font-semibold border border-gray-200 rounded-xl px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-purple-200 text-gray-700">
