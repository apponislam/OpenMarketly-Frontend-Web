  ...
  return (
    <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col cursor-pointer">
      <div className="relative overflow-hidden bg-gray-50 aspect-square" onClick={() => onView(product)}>
        ...
        {product.badge && (
          <span
            className="absolute top-3 left-3 text-white text-[10px] font-black px-2.5 py-1 rounded-full uppercase"
        ...
        {discount > 0 && (
          <span className="absolute top-3 right-9 bg-red-500 text-white text-[10px] font-black px-2 py-1 rounded-full">
            -{discount}%
          </span>
        )}
        <button
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <h3
          className="text-sm font-semibold text-gray-800 line-clamp-2 mb-2 leading-snug flex-1 hover:text-[#2c1654] transition-colors"
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => onView(product)}
            className="px-3 py-2.5 rounded-xl border border-purple-200 hover:bg-purple-50 transition-colors text-[#2c1654]"
            title="View Details"
          >
