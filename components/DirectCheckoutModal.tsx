      ...
      >
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-gray-400 hover:text-gray-900 w-8 h-8 rounded-full hover:bg-gray-100 flex items-center justify-center font-bold"
          >
            ✕
          </button>
        </div>
        ...
        <button
          type="submit"
          className="w-full py-4 mt-6 bg-[#2c1654] hover:opacity-90 text-white font-black text-sm rounded-xl transition-all shadow-xl"
        >
          Pay via SSLCommerz
        </button>
      </form>
